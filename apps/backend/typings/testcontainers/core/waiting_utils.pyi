...
def wait_for_logs(container: DockerContainer, predicate: Union[Callable[..., bool], str], timeout: Union[float, None] = ..., interval: float = ..., predicate_streams_and: bool = ..., raise_on_exit: bool = ...) -> float:
    """
